...
namespace MilkTeaShop.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public OrderController(IOrder _service)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] IEnumerable<Order> data)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] IEnumerable<Order> data)
        {
