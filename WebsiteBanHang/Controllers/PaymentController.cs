...
namespace MilkTeaShop.Controllers
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        public PaymentController(IPayment _service)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] IEnumerable<Payment> data)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] IEnumerable<Payment> data)
        {
